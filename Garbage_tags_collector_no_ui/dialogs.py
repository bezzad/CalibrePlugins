...
class RemoveDialog(Dialog):
    def __init__(self, parent):
        ...
        Dialog.__init__(self, _('حذف تگ های اضافه'), 'toolbag_spans_divs_dialog', parent)
    ...
    def setup_ui(self):
        ...
        label = QLabel(_('تگ های دارای ویژگی (Attribute)'), self)
        ...
        label = QLabel(_("مقدار ویژگی را بدون کوتیشن وارد کنید"), self)
    ...
    def _ok_clicked(self):
        ...
        if srch_str is None and attribute is not None:
            return error_dialog(self.parent, _('خطا'), '<p>{0}'.format(
                    _('یک مقدار برای فیلد ویژگی وارد کنید.')), det_msg='', show=True)
        srch_method = 'normal'
        newtag = None
        new_str = ''
        copy_attr = False
