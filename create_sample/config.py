...
class ConfigWidget(QWidget):
    ...
    def save_settings(self):
        ...
        prefs['sourcecol'] = unicode(
            convert_qvariant(self.columns_tab.sourcecol.itemData(self.columns_tab.sourcecol.currentIndex())))
...
class BasicTab(QWidget):
    def __init__(self, parent_dialog, plugin_action):
        ...
        label = QLabel(_(
            "These controls aren't plugin settings as such, but convenience buttons for setting Keyboard shortcuts and getting all the EpubSplit confirmation dialogs back again."))
        label.setWordWrap(True)
        self.l.addWidget(label)
        self.l.addSpacing(5)
...
class CustomColumnsTab(QWidget):
    def __init__(self, parent_dialog, plugin_action):
        ...
        label = QLabel(_(
            "If you have custom columns defined, they will be listed below.  Choose if you would like these columns copied to new split books."))
        label.setWordWrap(True)
        self.l.addWidget(label)
        self.l.addSpacing(5)
        ...
        label.setToolTip(_(
            "If set, the column below will be populated with the template below to record the source of the split file."))
        label.setWordWrap(True)
        self.l.addWidget(label)
